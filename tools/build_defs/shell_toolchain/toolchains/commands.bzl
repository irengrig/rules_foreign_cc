CommandInfo = provider(
    doc = "To pass information about the Starlark function,\
     defining the shell fragment.",
    fields = {
        "arguments": "Arguments of Starlark function",
        "doc": "What the shell script fragment, generated by this function,\
         does.",
    },
)
...
PLATFORM_COMMANDS = {
    ...
    "rm_rf": CommandInfo(
        arguments = [ArgumentInfo(
            name = "path",
            type_ = type(""),
            doc = "Path to directory",
        )],
        doc = "Deletes file or directory recursively with the force option \
        (non-interactively).",
    ),
    "mkdirs": CommandInfo(
        arguments = [ArgumentInfo(
    ...
    "replace_in_files": CommandInfo(
        ...
        doc = "Replaces all occurrences of 'from_' to 'to_' recursively \
    ...
    "copy_dir_contents_to_dir": CommandInfo(
        arguments = [
            ArgumentInfo(
                name = "source",
                type_ = type(""),
                doc = "Source directory, immediate children of which \
                are copied",
            ),
            ArgumentInfo(
                name = "target",
    ...
    "symlink_contents_to_dir": CommandInfo(
        arguments = [
            ArgumentInfo(
                ...
                type_ = type(""),
                doc = "Source directory, immediate children of which\
                 are symlinked, or file to be symlinked.",
            ),
            ArgumentInfo(
                name = "target",
                type_ = type(""),
...
NB symlinks from the source directory are copied.""",
    ...
    "script_prelude": CommandInfo(
        arguments = [],
        doc = "Function for setting necessary environment variables \
        for the platform",
    ),
    "increment_pkg_config_path": CommandInfo(
        ...
        doc = """Find subdirectory inside a passed directory with *.pc files \
        and add it
    ...
    "redirect_out_err": CommandInfo(
        arguments = [
            ...
            ArgumentInfo(
                name = "to_file",
                type_ = type(""),
                doc = "File to redirect output to",
            ),
        ],
        doc = "Read the result of the execution of the previous command, \
        execute success or failure callbacks",
    ),
    "cleanup_function": CommandInfo(
        arguments = [
            ArgumentInfo(
                name = "on_success",
                type_ = type(""),
                doc = "Command(s) to be executed on success",
            ),
            ArgumentInfo(
                name = "on_failure",
                type_ = type(""),
                doc = "Command(s) to be executed on failure",
            ),
        ],
    ...
    "define_absolute_paths": CommandInfo(
        arguments = [
            ArgumentInfo(
                name = "dir_",
                type_ = type(""),
                doc = "Directory where to replace",
            ),
            ArgumentInfo(
                name = "abs_path",
                type_ = type(""),
                doc = "Absolute path value",
            ),
        ],
        doc = "Replaces absolute path placeholder inside 'dir_' \
        with a provided value 'abs_path'",
    ),
    "replace_absolute_paths": CommandInfo(
        ...
        doc = "Replaces absolute path 'abs_path' inside 'dir_' \
